...
FT_Outline_MoveToFunc  = CFUNCTYPE(c_int, POINTER(FT_Vector))
FT_Outline_LineToFunc  = CFUNCTYPE(c_int, POINTER(FT_Vector))
FT_Outline_ConicToFunc = CFUNCTYPE(c_int, POINTER(FT_Vector), POINTER(FT_Vector))
FT_Outline_CubicToFunc = CFUNCTYPE(c_int, POINTER(FT_Vector), POINTER(FT_Vector), POINTER(FT_Vector))
